  ...
  <div class="container">
    ...
    <div class="contents">
      ...
      <div class="panel text">
        ...
        <a href="./about/about-writing-services.php">
          ...
          <div class="popup-container">
            ...
            <div id="nursing-menu" class="vertical-btn-group btn-group">
              ...
              <a href="/nursing/become-assistant.php">
                <button class="btn">BECOME AN ASSISTANT<br>IN NURSING (AIN)</button>
              </a>
              <a href="/nursing/become-registered.php">
                <button class="btn">BECOME A<br>REGISTER NURSE (RN)</button>
              </a>
              <a href="/nursing/become-enrolled.php">
                <button class="btn">BECOME AN<br>ENROLLED NURSE (EN)</button>
              </a>
