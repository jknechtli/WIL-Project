  ...
  <div class="container">
    ...
    <div class="contents">
      ...
      <div class="description">
        ...
        <img src="/img/teacher-resumes-1.webp" alt="" />
        <p>
        ...
        <img src="/img/teacher-resumes-2.webp" alt="" />
        <ul>

          <li> Resumes </li>
          <li>Cover letters </li>
          <li>Answers to selection criteria </li>
          <li>Answers to government suitability statements </li>
        ...
        <div class="split">
          ...
          <div>
            ...
            <ul>
              ...
              <li>Principals </li>
              <li>Compliance Managers / Quality Managers </li>
              <li>School Business Managers </li>
              <li>International Recruitment Managers </li>
              <li>International Education Marketing Managers </li>
              <li>RTO College Managers </li>
              <li>VET Sector Managers </li>
            </ul>
          </div>
        </div>
      </div>
