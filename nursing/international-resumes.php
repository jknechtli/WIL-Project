  ...
  <div class="container">
    ...
    <div class="contents">
      ...
      <div class="description">
        ...
        <h3> Current Australian Nursing Graduate Programs </h3>
        <p>
        ...
        <h3> AHPRA (Australia Health Practitioner Regulation Agency) https://www.ahpra.gov.au/ </h3>
        <p>
        ...
        <h3> SELECTION CRITERIA AND SUITABILITY STATEMENTS FOR NURSES </h3>
        <p>
        ...
        <h3>Why is Selection Criteria Important for Jobseekers? </h3>
        <p> When answered well, the selection criteria can help employees to: </p>
        <ol>
        ...
        <h3>How Can Selection Criteria Help Employers? </h3>
        ...
        <h3>How Can You Use Selection Criteria to Sell Yourself as a Jobseeker? </h3>
        ...
        <h3>LINKEDIN PROFILES FOR NURSES</h3>
        <p>
